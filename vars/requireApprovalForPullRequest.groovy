...
def call(String approvalGroup) {
	if (!env.CHANGE_AUTHOR) {
		echo "This doesn't look like a pull request; no approval required."
		return
	}
...
Please check the code seem safe to build: no attempt to abuse resources, inspect secrets, etc.""", submitter: approvalGroup
}
